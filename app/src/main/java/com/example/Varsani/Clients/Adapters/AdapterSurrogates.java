...
public class AdapterSurrogates extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private List<SurrogateModal> items;
    private List<SurrogateModal> searchView;
    ...
    public void setOnItemClickListener(final AdapterSurrogates.OnItemClickListener mItemClickListener) {
        this.mOnItemClickListener = mItemClickListener;
    }

    public void setOnMoreButtonClickListener(final AdapterSurrogates.OnMoreButtonClickListener onMoreButtonClickListener) {
        this.onMoreButtonClickListener = onMoreButtonClickListener;
    }

    public AdapterSurrogates(Context context, List<SurrogateModal> items) {
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterSurrogates.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterSurrogates.OriginalViewHolder) {
            final AdapterSurrogates.OriginalViewHolder view = (AdapterSurrogates.OriginalViewHolder) holder;

            final SurrogateModal p = items.get(position);
...
//    }
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, SurrogateModal obj, int pos);
    }

    public interface OnMoreButtonClickListener {
        void onItemClick(View view, SurrogateModal obj, MenuItem item);
    }
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<SurrogateModal> filteredList = new ArrayList<>();

                    for (SurrogateModal androidVersion : items) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                items = (ArrayList<SurrogateModal>) filterResults.values;
