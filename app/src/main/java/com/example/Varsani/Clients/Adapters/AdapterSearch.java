...
import com.example.Varsani.Clients.Models.SearchModel;
...
public class AdapterSearch extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<SearchModel> searchView;
    ...
    public void setOnItemClickListener(final AdapterSearch.OnItemClickListener mItemClickListener) {
        this.mOnItemClickListener = mItemClickListener;
    }

    public void setOnMoreButtonClickListener(final AdapterSearch.OnMoreButtonClickListener onMoreButtonClickListener) {
        this.onMoreButtonClickListener = onMoreButtonClickListener;
    }

    public AdapterSearch(Context context, List<SearchModel> items) {
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterSearch.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterSearch.OriginalViewHolder) {
            final AdapterSearch.OriginalViewHolder view = (AdapterSearch.OriginalViewHolder) holder;

            final SearchModel p = items.get(position);
            ...
            view.tv_full_name.setText(p.getProductName());
            view.tv_location.setText("Age: "+p.getStock());
            view.tv_age.setText("Blood Type: "+p.getDesc());
            view.tv_price.setText("Fee: "+p.getStock() + " /=");
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (SearchModel androidVersion : items) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                items = (ArrayList<SearchModel>) filterResults.values;
