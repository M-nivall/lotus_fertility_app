...
public class Login extends AppCompatActivity {
    ...
    private TextView gotoforgot,txv_staffLogin,txv_register;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txv_staffLogin = findViewById(R.id.txv_staffLogin);
...
//        user=session.getUserDetails();
    ...
    public void select(View v) {
        ...
        final String[] array = {"Intended Parents","Surrogate Mother","Egg Donor"};

        builder.setSingleChoiceItems(array, -1, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                edt_select.setText(array[i]);
                Toast.makeText(Login.this, array[i], Toast.LENGTH_SHORT).show();
