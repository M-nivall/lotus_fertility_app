...
public class Accept extends AppCompatActivity {
    private TextView txv_requestID,txv_name,txv_items,
            txv_requestDate, txv_requestStatus, txt_unitprice,txt_quantity,txv_quantity;
    ...
    private LinearLayout receipt_navbar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receipt_navbar =findViewById(R.id.receipt_navbar);

        receipt_navbar.setVisibility(View.GONE);
        ...
        txv_quantity.setText("Quantity: " +  quantity);
        ...
        if (in.getStringExtra("requestStatus").equals("Paid")){
            btn_submit.setVisibility(View.GONE);
            receipt_navbar.setVisibility(View.VISIBLE);
        }
        ...
        if (product.equals("UltraSound Gel")){
            unitprice = 450;
            txt_unitprice.setText("Price: Kes "+unitprice+"/unit");
            totalcharge = unitprice*quantity;
            edt_amount.setText("Total Amount: Kes "+totalcharge);
        ...
        if (product.equals("Stereomicroscope")){
            unitprice = 5000;
            txt_unitprice.setText("Price: Kes "+unitprice+"/unit");
            totalcharge = unitprice*quantity;
            edt_amount.setText("Total Amount: Kes "+totalcharge);
        ...
        if (product.equals("Crossmatching")){
            unitprice = 700;
            txt_unitprice.setText("Price: Kes "+unitprice+"/unit");
            totalcharge = unitprice*quantity;
            edt_amount.setText("Total Amount: Kes "+totalcharge);
