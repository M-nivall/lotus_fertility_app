...
public class TrackCheckups extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_track_checkups);

        getSupportActionBar().setSubtitle("Track Checkup");
    ...
    public void trackCheckup(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Urls.URL_TRACK_CHECKUP,
