...
//    }
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView txv_requestID,txv_name,txv_items,
                txv_quantity, txv_requestStatus;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.lv_payment_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.txv_name.setText("Tender: "+o.getSupplierName());
