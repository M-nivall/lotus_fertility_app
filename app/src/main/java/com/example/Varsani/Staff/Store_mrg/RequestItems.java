...
public class RequestItems extends AppCompatActivity {
    ...
    private Button btn_next,btn_medicine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_medicine.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(getApplicationContext(), RequestMedicine.class);
                in.putExtra("type", "medicine");
                startActivity(in);
            }
        });
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                for(int i=0; i <jsonArray.length();i++){
                                    ...
                                    String item_type=jsn.getString("item_type");
