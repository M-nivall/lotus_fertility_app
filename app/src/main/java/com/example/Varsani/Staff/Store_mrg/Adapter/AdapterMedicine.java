...
import com.example.Varsani.Staff.Store_mrg.ApproveEquipments;
import com.example.Varsani.Staff.Store_mrg.ApproveMedicine;
import com.example.Varsani.Staff.Store_mrg.Model.RequestModel;

import java.util.List;

public class AdapterMedicine extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
...
//    }
    ...
    public AdapterMedicine(Context context, List<RequestModel> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterMedicine.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterMedicine.OriginalViewHolder) {
            final AdapterMedicine.OriginalViewHolder view = (AdapterMedicine.OriginalViewHolder) holder;

            final RequestModel o= items.get(position);

            view.txv_requestID.setText("#ID: "+o.getRequestID());
            view.txv_name.setText("Pharmacist: "+o.getName());
            view.txv_requestDate.setText("Date: "+o.getRequestDate());
            //view.txv_requestStatus.setText("Status "+o.getRequestStatus());
            view.txv_items.setText("Medicine: "+o.getItems());
            ...
            if (o.getRequestStatus().equals("Pending")){
                ...
                view.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent in=new Intent(ctx, ApproveMedicine.class);
