...
public class ApprovedSurrogacy extends AppCompatActivity {
    private List<SurrogacyModel> list;
    private AdapterSurrogacy adapterSurrogacy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approved_surrogacy);
    ...
    public void approvedSurrogacy(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_APPROVED_SURROGACY,
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    SurrogacyModel surrogateModel = new SurrogacyModel(
                                ...
                                adapterSurrogacy=new AdapterSurrogacy(getApplicationContext(),list);
                                recyclerView.setAdapter(adapterSurrogacy);
