...
import static com.example.Varsani.utils.Urls.URL_DONOR_TEST;
...
public class DonorTests extends AppCompatActivity {
    private ProgressBar progressBar;
    private RecyclerView recyclerView;
    private List<MedicalTestModel> list;
    private AdapterMedicalTest adapterMedicalTest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donor_tests);
    ...
    public void getAssignedOrders() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_DONOR_TEST,
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                for(int i=0;i <jsonArray.length();i++){
                                    ...
                                    String scheduleStatus=jsn.getString("scheduleStatus");
                                    String bloodGroup=jsn.getString("bloodGroup");
                                    ...
                                    MedicalTestModel medicalTestModel=new MedicalTestModel(surrogateId,medicalDate,
                                            scheduleStatus,bloodGroup,medication,fullName,phoneNo,email,user,equipment_status,scheduleID);
                                    list.add(medicalTestModel);
                                }
                                progressBar.setVisibility(View.GONE);
                                adapterMedicalTest=new AdapterMedicalTest(getApplicationContext(),list);
                                recyclerView.setAdapter(adapterMedicalTest);
                            }else{
