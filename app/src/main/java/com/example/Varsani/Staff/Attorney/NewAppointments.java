...
public class NewAppointments extends AppCompatActivity {
    ...
    public void newAppointments() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_NEW_APPOINTMENTS,
                        ...
                        try {
                            ...
                            if(status.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    String parentName = jsn.getString("parent_name");
                                    String parentPhone = jsn.getString("parent_phone");
                                    String parentEmail = jsn.getString("parent_email");
                                    String surrogateName = jsn.getString("surrogate_name");
                                    String surrogatePhone = jsn.getString("surrogate_phone");
                                    String surrogateEmail = jsn.getString("surrogate_email");
                                    String schedule_type = jsn.getString("schedule_type");

                                    // Create AppointmentModel object
                                    AppointmentModel appointmentModel = new AppointmentModel(
                                            id, scheduleId, parentId, surrogateId, partnerName, partnerContact,
                                            scheduleDate, parentName, parentPhone, parentEmail,
                                            surrogateName, surrogatePhone, surrogateEmail, schedule_type
                                    );
                                ...
                                adapterAppointment = new AdapterAppointment(getApplicationContext(), list);
