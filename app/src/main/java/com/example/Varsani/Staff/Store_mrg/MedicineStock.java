...
import com.example.Varsani.Staff.Store_mrg.Adapter.AdapterMedicineStock;
...
public class MedicineStock extends AppCompatActivity {
    ...
    private AdapterMedicineStock adapterMedicineStock;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Medicine Stock");
    ...
    private void search(SearchView searchView) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                adapterMedicineStock.getFilter().filter(newText);
    ...
    public void getStock(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Urls.URL_MEDICINE_STOCK,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("1")){
                                ...
                                adapterMedicineStock=new AdapterMedicineStock(getApplicationContext(),list);
                                recyclerView.setAdapter(adapterMedicineStock);
