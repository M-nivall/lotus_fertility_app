...
public class ApproveEquipments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approve_equipments);
        ...
        edt_quotation.setText("Lab Tech: "+in.getStringExtra("supplier"));
        txv_items.setText("Equipments: "+in.getStringExtra("item"));
    ...
    public void approve(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_APPROVE_EQUIPMENTS,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("1")){
                                ...
                                Toast toast= Toast.makeText(ApproveEquipments.this, msg, Toast.LENGTH_SHORT);
                            ...
                            e.printStackTrace();
                            Toast toast= Toast.makeText(ApproveEquipments.this, e.toString(), Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.TOP,0,250);
                            toast.show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast toast= Toast.makeText(ApproveEquipments.this, error.toString(), Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.TOP,0,250);
                toast.show();
            }
        }){
