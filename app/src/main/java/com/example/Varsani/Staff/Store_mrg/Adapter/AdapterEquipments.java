...
public class AdapterEquipments extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
...
//    }
    ...
    public AdapterEquipments(Context context, List<RequestModel> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterEquipments.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterEquipments.OriginalViewHolder) {
            final AdapterEquipments.OriginalViewHolder view = (AdapterEquipments.OriginalViewHolder) holder;

            final RequestModel o= items.get(position);

            view.txv_requestID.setText("#ID: "+o.getRequestID());
            view.txv_name.setText("Lab Tech: "+o.getName());
            view.txv_requestDate.setText("Date: "+o.getRequestDate());
            //view.txv_requestStatus.setText("Status "+o.getRequestStatus());
            view.txv_items.setText("Equipments: "+o.getItems());
            ...
            if (o.getRequestStatus().equals("Pending")){
                ...
                view.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent in=new Intent(ctx, ApproveEquipments.class);
