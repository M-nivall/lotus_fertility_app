...
import static com.example.Varsani.utils.Urls.URL_APPROVE_EQUIPMENTS;
import static com.example.Varsani.utils.Urls.URL_APPROVE_MEDICINE;
...
public class ApproveMedicine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approve_medicine);
        ...
        edt_quotation.setText("Pharmacist: "+in.getStringExtra("supplier"));
        txv_items.setText("Medicine: "+in.getStringExtra("item"));
        edt_expectedDate.setText("Date: "+in.getStringExtra("requestDate"));
        txv_requestStatus.setText("Status : "+in.getStringExtra("requestStatus"));
        txv_amount.setText("ID: "+in.getStringExtra("amount"));
    ...
    public void approve(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_APPROVE_MEDICINE,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("1")){
                                ...
                                Toast toast= Toast.makeText(ApproveMedicine.this, msg, Toast.LENGTH_SHORT);
                            ...
                            e.printStackTrace();
                            Toast toast= Toast.makeText(ApproveMedicine.this, e.toString(), Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.TOP,0,250);
                            toast.show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast toast= Toast.makeText(ApproveMedicine.this, error.toString(), Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.TOP,0,250);
                toast.show();
            }
        }){
    ...
    public void alertApprove(){
        ...
        alertDialog.setMessage("Approve this request");
