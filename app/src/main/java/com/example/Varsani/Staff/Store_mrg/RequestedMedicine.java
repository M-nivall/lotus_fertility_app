...
import static com.example.Varsani.utils.Urls.URL_REQUESTED_MEDICINE;
...
import com.example.Varsani.Staff.Store_mrg.Adapter.AdapterMedicine;
...
public class RequestedMedicine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_requested_medicine);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Requested Medicine");
    ...
    public void requests(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_REQUESTED_MEDICINE,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                adapter=new AdapterMedicine(getApplicationContext(),list);
