package com.example.Varsani.Donor;
...
public class TrackMyApplication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_track_my_application);
    ...
    public void myApplication() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Urls.URL_TRACK_APPLICATION,
